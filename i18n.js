...
const i18n = {
  ...
  getCurrentLang: function () {
    try {
      ...
      return data.lang && this.languages[data.lang]
        ? data.lang
        : this.defaultLang;
    } catch (e) {
  ...
  translations: {
    en: {
      ...
      // Meta descriptions
      meta_create:
        "Create and split expenses with friends. Privacy-first, no accounts required.",
      meta_share:
        "Share your expense receipt with others. Copy the link and send it.",
      meta_receipt:
        "View and print your expense receipt. Privacy-first expense splitting.",
    ...
    fa: {
      ...
      // Meta descriptions
      meta_create: "هزینه‌ها را با دوستان تقسیم کنید بدون نیاز به ساخت اکانت..",
      meta_share:
        "رسید هزینه خود را با دیگران به اشتراک بگذارید. لینک را کپی کرده و ارسال کنید.",
      meta_receipt:
        "رسید هزینه خود را مشاهده و چاپ کنید. تقسیم هزینه با حفظ حریم خصوصی.",
    ...
    de: {
      ...
      // Meta descriptions
      meta_create:
        "Erstellen und teilen Sie Ausgaben mit Freunden. Datenschutz zuerst, keine Konten erforderlich.",
      meta_share:
        "Teilen Sie Ihre Ausgabenquittung mit anderen. Kopieren Sie den Link und senden Sie ihn.",
      meta_receipt:
        "Zeigen und drucken Sie Ihre Ausgabenquittung. Datenschutzorientierte Ausgabenteilung.",
      ...
      share_description:
        "Kopieren Sie den untenstehenden Link und teilen Sie ihn mit anderen:",
      ...
      validation_participants_required:
        "Bitte fügen Sie mindestens einen Teilnehmer hinzu",
      ...
      error_unsupported_version:
        "Diese Quittungsversion wird nicht unterstützt",
  ...
  t: function (key, lang = null) {
    ...
    const translations =
      this.translations[currentLang] || this.translations[this.defaultLang];
  ...
  formatCurrency: function (amount, currency, lang = null) {
    ...
    try {
      ...
      return `${amount.toFixed(2)} ${this.t(
        "currency_" + currency,
        currentLang
      )}`;
    }
  ...
  formatDate: function (date, lang = null) {
    ...
    try {
      return new Intl.DateTimeFormat(
        currentLang,
        this.translations[currentLang].date_format
      ).format(date);
    } catch (e) {
